...
- **Notizen** — Markdown-Editor mit Vorschau und Obsidian-kompatiblen `[[Wikilinks]]` zwischen Notizen. Ein **Backlinks-Panel** („Verlinkt von") zeigt, welche Notizen auf die aktuelle verweisen.
